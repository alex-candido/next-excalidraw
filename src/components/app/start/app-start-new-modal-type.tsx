...
interface AppStartNewModalTypeProps {
...
export function AppStartNewModalType({
  value,
  onChange,
}: AppStartNewModalTypeProps) {
  const t = useTranslations("app.new.type");

  return (
    <div className="app-start-new-modal-type flex gap-2.5">
      {TYPE_OPTIONS.map((option) => {
        ...
        return (
          <button
            ...
            className={cn(
              "app-start-new-modal-type-card flex flex-1 flex-col gap-3 rounded-xl border p-3 text-left transition-colors",
              isSelected
          ...
          >
            <div
              className={cn(
                "app-start-new-modal-type-card-icon flex size-8 items-center justify-center rounded-md",
            ...
            <div className="app-start-new-modal-type-card-text flex flex-col gap-0.5">
              <span
                className={cn(
                  "text-sm font-medium",
